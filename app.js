...
function sumAndMultiply(a,b,c){ //eslint-disable-line
  ...
  var tripleSum = sum(sum(a,b),c)[0];
  var tripleProduct = multiply(multiply(a,b),c)[0];
  var messageSum = a + ' and '+ b + ' and '+ c + ' sum to ' + tripleSum + '.';
  var messageProduct = 'The product of '+ a + ' and '+  b + ' and '+ c + ' is '+ tripleProduct + '.';
  return [tripleSum, tripleProduct, messageSum, messageProduct];
